    ...
    export class Level1 extends objects.Scene
    {
        ...
        public Update():number
        {
            ...
            this.zombie.forEach(zombies =>
            {
                ...
                this.collision.checkCollision(zombies, this.level1_leftWindow);   
                this.collision.checkCollision(zombies, this.level1_rightWindow);  
            });  
        ...
        {   
            if (this.level1_leftWindow.windowLeftHealth >= 650) // Display Green Bar indicating over 75% Health
            {
            ...
            else if (this.level1_leftWindow.windowLeftHealth >=450)   // Display Orange Bar indicating over 45% Health
            {
            ...
            else if (this.level1_leftWindow.windowLeftHealth <=450)   // Display Red Bar indicating less than 45% Health
            {
        ...
        {   
            if (this.level1_rightWindow.windowRightHealth >= 650) // Display Green Bar indicating over 75% Health
            {
            ...
            else if (this.level1_rightWindow.windowRightHealth >=450)   // Display Orange Bar indicating over 45% Health
            {
            ...
            else if (this.level1_rightWindow.windowRightHealth <=450)   // Display Red Bar indicating less than 45% Health
            {
